...
int utility_2(struct environment env);


/*
	Designer-intention temporal function sequence
...
/*
	Prioritizes turning as many tasks off as possible
*/
int utility_2(struct environment env)
{
	return env.ag.count;
